  ...
  return (
    <div className="personal">
      ...
      <p className="para">
        ...
        <div>
          I'm a web developer from Nigeria. My coding career began in 2017 when a friend introduced me to front-end programming, and it has enthralled me ever since I wrote my first "Hello, World" in HTML and saw it displayed in the browser. <br /> <br />
